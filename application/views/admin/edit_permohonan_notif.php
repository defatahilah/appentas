    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <?php foreach ($tpermohonan as $pmhn) { ?>
                ...
                <form action="<?php echo base_url() . 'C_Admin/Permohonan/ubah_permohonan_notif_aksi'; ?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-row justify-content-center">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="status" class="form-control" value="<?php echo $pmhn->status ?>" readonly>
                        </div>
                    </div>
