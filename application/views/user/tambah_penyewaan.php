            ...
            <form action="<?php echo base_url() . 'C_User/Penyewaan/tambah_penyewaan_aksi'; ?>" method="post" class="form-horizontal">
                ...
                <div class="form-row justify-content-center" hidden>
                    <div class="col-md-6 form-group">
                        ...
                        <input name="tgl_sewa" class="form-control" value="<?= date('Y/m/d G:i:s'); ?> " id="tgl_sewa" hidden readonly>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select onchange="ubahharga(event);cektanggal(event) " id="nm_ruangan" name="id_ruangan" class=" form-control">
                            <option value="" disabled selected>-- Pilih Nama Ruangan --</option>
